...
# Properties to plot
properties = ['struct_opt_dm', 'drift_rate', 'fluence_Jyms']
errors = ['struct_opt_dm_err', 'drift_rate_err', 'fluence_err']
ylabel = ['DM (pc cm$^{-3}$)', 'Drift rate (MHz ms$^{-1}$)', 'Fluence (Jy ms)']
